...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record3<Long, String, OffsetDateTime> {
    ...
    public LinksRecord(@Nullable Long id, @NotNull String url, @Nullable OffsetDateTime lastUpdated) {
        super(Links.LINKS);
     ...
     * Create a detached, initialised LinksRecord
     */
    public LinksRecord(edu.java.jooq.domain.tables.pojos.Links value) {
        super(Links.LINKS);
